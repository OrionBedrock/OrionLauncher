...
/// <summary>
/// Ensures Linux GDK runtime components are present:
...
public interface IGdkLinuxRuntimeService
{
    ...
    /// <summary>
    /// Downloads or reuses cached tools, extracts archives, applies chmod 755 recursively, and returns resolved paths.
    /// </summary>
